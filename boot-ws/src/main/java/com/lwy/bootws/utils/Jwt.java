...
public class Jwt {
    ...
    public static Map<String, String> params(String jwtToken) {
        ...
        String payload = EbagUtils.unbase64UrlSafe(jwtToken.substring(0, dotIndex));
    ...
    private static String sign(Map<String, String> params, String appKey) {
        ...
        return EbagUtils.md5(signedText.toString());
    }
    ...
    public static class Builder {
        ...
        public String token() {
            ...
            // 计算签名
            String payload   = EbagUtils.base64UrlSafe(JSON.toJSONString(params));
